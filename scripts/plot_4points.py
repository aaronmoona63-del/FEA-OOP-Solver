...
time_cg      = [3.100, 60.837, 142.119, 158.994]  # 422k时与Pardiso发生交汇
time_pcg     = [2.170, 86.623, 190.299, 297.385]  # 反映单步开销增加的真实情况
